			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ShipLabel-display": {
								"semanticObject": "ShipLabel",
								"action": "display",
								"description": "Ship Label Application",
								"title": "Ship Label",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=oup.ewm.zewmshiplbl",
									"url": sap.ui.require.toUrl("oup/ewm/zewmshiplbl")
								}
							}
						}
					}
